        ...
        <div class="container-fluid firstContainerImage">
            ...
            <div class="firstContainer col-lg-5 col-sm-5 col-xs-12">
                <form class="Fname" method="POST" action="pageDirector">
                    <label class="form-label" for="Name">Enter First Name:</label><span class="warningName"></span>
                <input class="form-control mb-3" id="Name" name="Name" placeholder="Name" maxlength="30" type="text" required/>
                <label class="form-label" for="Email">Enter Email:</label><span class="warningName"></span>
                ...
                <div class="form-group">
                    <select name="role" class="form-control" style="font-size:20px">
                ...
                <div class="form-group">
                    <select name="place" class="form-control" style="font-size:20px">
                        <option>select</option>        
