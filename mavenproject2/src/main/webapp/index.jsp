  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        <div class="row firstContainer mt-4">
            ...
            <div class="container col-lg-3  col-sm-6 col-xs-12 imgContainer1 p-0">
                <img src="images/laptop.png" class="fig1">
            </div>
            <div class="conatiner col-lg-9 col-sm-6 col-xs-12 p-0">
         ...
         <div class="row secondContainer mt-4">
            ...
            <div class="container col-lg-3 col-sm-6 col-xs-12 imgContainer2 p-0">
                <img src="images/setshscope.jpg" class="fig2">
            </div>
            <div class="container col-lg-9 col-sm-6 col-xs-12  p-0">
        ...
        <hr>
        <div class="row m-0">
        <div class="container sideFifthContainer col-lg-3 col-sm-12 mt-5 pr-1 ">
            <h5>FIND US</h5>
            <ul class="list-group">
        ...
        <div class="container-fluid thirdContainer col-lg-5 col-sm-12 mt-5">
                ...
                <div class="container sideFifthContainer col-lg-3 pl-1 col-sm-12 mt-5">
