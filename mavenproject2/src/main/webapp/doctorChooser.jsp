...
<html>
  ...
  <link rel="stylesheet" href="styles/doctorChooser.css"> 
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body>
        <nav class="navbar navbar-expand-sm" style="background-color:#FB053C ">
            ...
            <div class="row m-0">
                <div class="patientDetailContainer col-lg-12 col-sm-12 col-xs-12 p-0">
                    <h3 class="header">Hey Doc lets get in to work!!!</h3>
                    <div class="conatiner1">
                        <img src="images/details_logo.png" style="width:150px;height:150px">
                        <a href="doctorUi.jsp" class="btn btn-success">click here <span style='font-size:15px; margin-left:6px'>&#10097;</span></a>
                    </div>
                </div>
            </div>
